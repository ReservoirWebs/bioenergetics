...
class Batch:
    def __init__(self, site_data, starting_mass, prey_data, temp_max,
    ...
    def compute_daphniabydepth(self, zooplankton_data):
        ...
        return (interp1d(x, y, bounds_error=False, fill_value=surface_count),
                trapz(y, x))
    ...
    def compute_foragingbydepth(self, StartingLength, starting_mass,
                                surface_light, daphline, daph_auc, depth):
    ...
    def compute_bioenergetics(self, W, temp, P, prey, digestibility):
        ...
        (egestion, excretion) = self.compute_waste(consumption, P, temp, prey,
                                                   digestibility)
        (respiration, SDAction) = self.compute_respiration(W, temp, egestion,
                                                           consumption)
    ...
    def growth_fn(self, day_depth, night_depth, StartingLength, starting_mass,
        ...
        day_foraging = self.compute_foragingbydepth(StartingLength,
                                                    starting_mass,
                                                    day_light, self.daphline,
                                                    self.daph_auc, day_depth)
        night_foraging = self.compute_foragingbydepth(StartingLength,
                                                      starting_mass,
        ...
        growth = self.compute_growth(consumption, prey, self.preyenergy,
                                     egestion, excretion, SDAction,
                                     respiration, self.predatorenergy,
                                     starting_mass)
